...
INSTANCES = [
    ...
    "instance-7.txt",  # |P|=28, |S|=24, |W|=14, MC=4, COL=37632
    "instance-8.txt",  # |P|=28, |S|=24, |W|=14, MC=4, COL=37632
    ...
    "instance-9.txt",  # |P|=28, |S|=26, |W|=14, MC=4, COL=40768
    "instance-50.txt",  # |P|=50, |S|=20, |W|=9, MC=5, COL=45000
    "instance-54.txt",  # |P|=38, |S|=20, |W|=16, MC=4, COL=48640
    "instance-60.txt",  # |P|=35, |S|=24, |W|=16, MC=4, COL=53760
    "instance-39.txt",  # |P|=68, |S|=23, |W|=12, MC=3, COL=56304
    "instance-35.txt",  # |P|=36, |S|=25, |W|=16, MC=4, COL=57600
    "instance-36.txt",  # |P|=36, |S|=25, |W|=16, MC=4, COL=57600
    ...
    "instance-12.txt",  # |P|=39, |S|=24, |W|=17, MC=4, COL=63648
    "instance-6.txt",  # |P|=63, |S|=20, |W|=11, MC=5, COL=69300
    "instance-11.txt",  # |P|=39, |S|=27, |W|=17, MC=4, COL=71604
    "instance-13.txt",  # |P|=41, |S|=25, |W|=18, MC=4, COL=73800
    "instance-5.txt",  # |P|=68, |S|=20, |W|=11, MC=5, COL=74800
    "instance-43.txt",  # |P|=80, |S|=20, |W|=10, MC=5, COL=80000
    "instance-18.txt",  # |P|=26, |S|=26, |W|=15, MC=8, COL=81120
    "instance-38.txt",  # |P|=74, |S|=23, |W|=12, MC=4, COL=81696
    "instance-46.txt",  # |P|=76, |S|=23, |W|=12, MC=4, COL=83904
    "instance-37.txt",  # |P|=28, |S|=26, |W|=15, MC=8, COL=87360
    "instance-32.txt",  # |P|=61, |S|=24, |W|=15, MC=4, COL=87840
    "instance-29.txt",  # |P|=68, |S|=20, |W|=11, MC=6, COL=89760
    ...
    "instance-31.txt",  # |P|=60, |S|=24, |W|=16, MC=4, COL=92160
    "instance-28.txt",  # |P|=68, |S|=23, |W|=13, MC=5, COL=101660
    "instance-53.txt",  # |P|=56, |S|=24, |W|=16, MC=5, COL=107520
    "instance-45.txt",  # |P|=78, |S|=23, |W|=12, MC=5, COL=107640
    "instance-26.txt",  # |P|=35, |S|=26, |W|=15, MC=8, COL=109200
    "instance-56.txt",  # |P|=32, |S|=27, |W|=16, MC=8, COL=110592
    "instance-1.txt",  # |P|=83, |S|=20, |W|=14, MC=5, COL=116200
    ...
    "instance-55.txt",  # |P|=69, |S|=24, |W|=16, MC=8, COL=211968
    "instance-33.txt",  # |P|=84, |S|=32, |W|=19, MC=5, COL=255360
    "instance-24.txt",  # |P|=61, |S|=32, |W|=19, MC=8, COL=296704
    "instance-20.txt",  # |P|=54, |S|=32, |W|=22, MC=8, COL=304128
    "instance-21.txt",  # |P|=55, |S|=32, |W|=23, MC=8, COL=323840
    "instance-34.txt",  # |P|=58, |S|=32, |W|=23, MC=8, COL=341504
    "instance-22.txt",  # |P|=71, |S|=32, |W|=20, MC=8, COL=363520
    "instance-23.txt",  # |P|=81, |S|=32, |W|=20, MC=8, COL=414720
    "instance-25.txt",  # |P|=104, |S|=32, |W|=24, MC=8, COL=638976, Out of Memory
    "instance-59.txt",  # |P|=56, |S|=55, |W|=26, MC=8, COL=640640
    "instance-19.txt",  # |P|=63, |S|=53, |W|=25, MC=8, COL=667800
    "instance-58.txt",  # |P|=63, |S|=55, |W|=28, MC=8, COL=776160
]
